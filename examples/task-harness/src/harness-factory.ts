 ...
 *
 * @module harness-factory
 */

import { type ContainerOptions, createContainer, IEventBusToken } from "@openharness/sdk";
import { ParserAgent, ValidationReviewAgent } from "@openharness/anthropic";
import { TaskHarness } from "./task-harness.js";
import type { TaskHarnessConfig } from "./task-harness-types.js";
 ...
 * @example
 * ```typescript
 * import { createTestTaskHarness } from '@openharness/example-task-harness';
 *
