...
/**
 * SpecKit Harness - Level 6 (Advanced Fixture Patterns)
 *
 * Same 3-agent workflow as Level 5, demonstrating advanced fixture patterns:
 ...
 * - Fixtures enable fast, free CI testing
 */
...
/**
 * Run the SpecKit harness with advanced fixture support.
 *
 * Fixture patterns:
 * - Each test gets its own fixture name for isolation
 * - Same fixture name = deterministic replay
 * - Different names = independent recordings
 */
