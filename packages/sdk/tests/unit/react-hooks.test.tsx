...
import { useHarness } from "../../src/client/react/use-harness.js";
import { useRuntime } from "../../src/client/react/use-runtime.js";
import { MockRuntime } from "../../src/testing/mocks/mock-runtime.js";
...
describe("react hooks", () => {
  ...
  test("useHarness returns idle state by default and sendMessage rejects", async () => {
    ...
    await expect(latest.sendMessage("hi")).rejects.toThrow(
