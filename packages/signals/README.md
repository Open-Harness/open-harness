...
```typescript
import { Player } from "@signals/bus";
...
```typescript
import { matchesPattern, matchesAnyPattern } from "@signals/bus";
...
```typescript
import { snapshot, snapshotAll, createEmptySnapshot } from "@signals/bus";
...
```typescript
import { attachReporter, attachReporters, createConsoleReporter, createMetricsReporter } from "@signals/bus";
...
import { SignalBus, MemorySignalStore } from "@signals/bus";
import { createSignal } from "@signals/core";
...
- `@signals/core` — Signal primitives and Provider interface
