...
import { PROVIDER_SIGNALS, type Signal } from "@internal/signals-core";
...
describe("ClaudeProvider", () => {
	...
	describe("signal emission", () => {
		...
		test("emits provider:error for error results", async () => {
			const mockMessages = [
				createMockResult({
		...
		test("all signals have source.provider", async () => {
			...
			// All signals should have source.provider = "claude"
