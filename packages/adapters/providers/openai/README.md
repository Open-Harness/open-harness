...
```bash
bun add @open-harness/provider-openai
```
...
```typescript
import { CodexProvider } from "@open-harness/provider-openai";
...
- [@open-harness/provider-claude](../claude/README.md) - Claude provider
