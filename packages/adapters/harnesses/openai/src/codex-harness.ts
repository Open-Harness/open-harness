/**
 * CodexHarness - Harness implementation for OpenAI Codex SDK
 *
...
/**
 * Codex-specific harness input extensions
 */
export interface CodexHarnessInput extends HarnessInput {
...
/**
 * Codex-specific harness output extensions
 */
export interface CodexHarnessOutput extends HarnessOutput {
...
/**
 * Configuration for CodexHarness
 */
...
// ============================================================================
// CodexHarness Implementation
// ============================================================================

/**
 * Harness for OpenAI Codex SDK
 *
 * Implements the Harness interface for @openai/codex-sdk.
 ...
 * ```
 */
export class CodexHarness implements Harness<CodexHarnessInput, CodexHarnessOutput> {
	readonly type = "codex";
	 ...
	 */
	async *run(input: CodexHarnessInput, ctx: RunContext): AsyncGenerator<Signal, CodexHarnessOutput> {
		...
		// Build final output
		const output: CodexHarnessOutput = {
			content: accumulatedText,
			toolCalls: toolCalls.length > 0 ? toolCalls : undefined,
			sessionId: threadId,
			threadId,
	...
	/**
	 * Build prompt from harness input
	 */
	private buildPrompt(input: CodexHarnessInput): string {
		const parts: string[] = [];
