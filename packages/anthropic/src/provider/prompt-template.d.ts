 ...
 */
export declare function createPromptTemplate<TTemplate extends string, TData extends Record<ExtractVars<TTemplate>, unknown> = Record<ExtractVars<TTemplate>, unknown>>(template: TTemplate, schema?: z.ZodType<TData>): PromptTemplate<TData>;
/**
 ...
 */
export declare function createStaticPrompt(prompt: string): PromptTemplate<Record<string, never>>;
