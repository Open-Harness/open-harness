...
```typescript
import type { Provider, ProviderInput, ProviderOutput, RunContext, Signal } from "@signals/core";
...
- [@signals/provider-claude](../providers/claude/README.md) - Claude provider
- [@signals/provider-openai](../providers/openai/README.md) - OpenAI provider
