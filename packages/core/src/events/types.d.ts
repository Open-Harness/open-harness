 ...
 */
export type BaseEvent = HarnessStartEvent | HarnessCompleteEvent | PhaseStartEvent | PhaseCompleteEvent | TaskStartEvent | TaskCompleteEvent | TaskFailedEvent | AgentStartEvent | AgentThinkingEvent | AgentTextEvent | AgentToolStartEvent | AgentToolCompleteEvent | AgentCompleteEvent | NarrativeEvent | SessionPromptEvent | SessionReplyEvent | SessionAbortEvent | ExtensionEvent;
/**
