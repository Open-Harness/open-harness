// Replay tests for Agent inbox interface
...
describe("Agent Inbox (replay)", () => {
	test("inbox supports pop, drain, and async iteration", async () => {
		const fixture = await loadAgentFixture("agent/inbox-basic");
