...
**[[concepts/agents|Agent]]**: A unit of AI behavior. Typed inputs, typed outputs. Provider-agnostic.

**[[concepts/harness|Harness]]**: The orchestration layer. Composes agents, manages state, provides helpers (retry, parallel, phases). Your business logic lives here.

**[[concepts/transports|Transport]]**: Where events go. Plug in any output destination. Console logging, WebSocket streaming, metrics collection - the community builds these.
...
→ [[concepts/_index|Core Concepts]]
→ [[examples/_index|Examples]]
