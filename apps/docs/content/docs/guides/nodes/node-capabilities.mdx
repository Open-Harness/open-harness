...
- [Register Nodes](/docs/guides/nodes/register-nodes) - Registration basics
- [Node Schemas](/docs/guides/nodes/node-schemas) - Input/output types
- [NodeTypeDefinition](/docs/reference/types/node-type-definition) - Full reference
