...
- [Attach Channel](/guides/channels/attach-channel) - Channel basics
- [Console Channel](/guides/channels/console-channel) - Text I/O example
- [Bidirectional Concepts](/concepts/channels/bidirectional) - Architecture
