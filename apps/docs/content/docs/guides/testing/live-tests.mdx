...
import { createAnthropicTextAgent, defineHarness } from "@open-harness/kernel";
...
describe("live: isolated", () => {
  ...
  beforeEach(() => {
    harness = defineHarness({ agents: [agent] });
  });
...
- [Unit Tests](/guides/testing/unit-tests) - Fast isolated tests
- [Replay Tests](/guides/testing/replay-tests) - Deterministic tests
