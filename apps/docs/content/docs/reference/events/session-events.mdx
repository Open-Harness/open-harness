...
- [Hub](/reference/api/hub) - reply() and abort() methods
- [SessionContext](/reference/types/session-context) - Session interface
- [Agent Events](/reference/events/agent-events) - Agent output
