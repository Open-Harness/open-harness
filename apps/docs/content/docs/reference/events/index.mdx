...
| Category | Purpose |
|----------|---------|
| [Workflow Events](/docs/reference/events/workflow-events) | Harness, phase, and task lifecycle |
| [Agent Events](/docs/reference/events/agent-events) | Agent execution and output |
| [Session Events](/docs/reference/events/session-events) | Interactive session communication |
| [Narrative Events](/docs/reference/events/narrative-events) | Logging and progress updates |

## Event Structure

All events are wrapped in an [EnrichedEvent](/docs/reference/types/enriched-event) envelope:
