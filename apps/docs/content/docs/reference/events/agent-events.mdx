...
- [Workflow Events](/reference/events/workflow-events) - Workflow lifecycle
- [Session Events](/reference/events/session-events) - Interactive sessions
- [AgentDefinition](/reference/types/agent-definition) - Agent interface
