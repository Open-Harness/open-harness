...
Array of [NodeSpec](/docs/reference/types/node-spec) definitions.
...
FlowYaml is validated using [FlowYamlSchema](/docs/reference/schemas/flow-yaml-schema):
...
- [NodeSpec](/docs/reference/types/node-spec) - Node definition
- [parseFlowYaml](/docs/reference/api/parse-flow) - Parse YAML to FlowYaml
- [compileFlow](/docs/reference/api/compile-flow) - Compile flow for execution
- [Flow Spec](/docs/reference/kernel-spec/flow/flow-spec) - Specification
