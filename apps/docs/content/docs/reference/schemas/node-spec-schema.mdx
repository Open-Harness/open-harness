...
- [FlowYamlSchema](/reference/schemas/flow-yaml-schema) - Complete flow validation
- [WhenExprSchema](/reference/schemas/when-expr-schema) - Condition validation
- [NodeSpec](/reference/types/node-spec) - Type definition
