...
| Schema | Purpose |
|--------|---------|
| [FlowYamlSchema](/docs/reference/schemas/flow-yaml-schema) | Validate complete flow definitions |
| [NodeSpecSchema](/docs/reference/schemas/node-spec-schema) | Validate individual node specifications |
| [WhenExprSchema](/docs/reference/schemas/when-expr-schema) | Validate conditional expressions |
...
- [NodeSpec](/docs/reference/types/node-spec) - Node specification type
- [parseFlowYaml](/docs/reference/api/parse-flow) - YAML parsing with validation
