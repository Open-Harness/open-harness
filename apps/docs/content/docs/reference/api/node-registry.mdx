...
- [executeFlow](/docs/reference/api/execute-flow) - Execute flows with registry
- [NodeTypeDefinition](/docs/reference/types/node-type-definition) - Definition interface
