...
- [defineHarness](/reference/api/define-harness) - API reference
- [ExecuteContext](/reference/types/execute-context) - Context type
- [HarnessResult](/reference/types/harness-result) - Result type
