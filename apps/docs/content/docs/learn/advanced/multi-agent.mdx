...
```typescript
import { defineHarness, createHub } from "@open-harness/kernel";
...
- **[Conditional Flows](/learn/advanced/conditional-flows)** - Add branching
- **[Hub Events](/learn/hub-events)** - Monitor execution
- **[Architecture Concepts](/concepts/architecture/overview)** - System design
