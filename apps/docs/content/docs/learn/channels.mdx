...
// Channel now receives all hub events
```
...
ctx.hub.abort({ reason: "User cancelled" });
```
...
- **[Testing](/docs/learn/testing)** - Test your flows
- **[Channel Adapter Pattern](/docs/concepts/channels/adapter-pattern)** - Concepts
- **[Bidirectional Channels](/docs/concepts/channels/bidirectional)** - Full-duplex I/O
