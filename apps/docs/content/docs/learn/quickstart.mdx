...
3. **Used JSONata bindings** (`{{ template.output }}`) to pass data between nodes
...
- **[Data Bindings with JSONata](/docs/guides/expressions/bindings)** — Master the expression language
- **[Architecture Overview](/docs/concepts/architecture/overview)** — Understand Hub, Flow, and Channels
- **[First Flow Tutorial](/docs/learn/first-flow)** — Deeper dive into flow structure
