...
- [Harness vs Flow](/concepts/architecture/harness-vs-flow) - Choosing the right model
- [Event-Driven Design](/concepts/architecture/event-driven) - Why events everywhere
- [Hub API](/reference/api/hub) - Complete Hub reference
