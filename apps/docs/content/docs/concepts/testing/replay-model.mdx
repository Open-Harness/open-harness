...
const harness = defineHarness({
  hub: mockHub,
  agents: [agentUnderTest]
});

await harness.run(fixture.input);
...
- [Conformance Testing](/concepts/testing/conformance) - Testing node types
- [Test Infrastructure](/guides/testing/test-setup) - Setting up tests
- [Recording Fixtures](/guides/testing/recording-fixtures) - How to record
