...
The imperative runtime is called "Harness" because:
- It "harnesses" agents together
- Implies control and coordination
- Evokes test harness patterns

Alternatives considered:
- "Runtime" - too generic
- "Orchestrator" - too enterprise-y
- "Runner" - too simple
- "Engine" - conflicts with implementation detail
...
defineHarness()     // Factory: creates a harness definition
...
- [Edges Required](/concepts/design-decisions/edges-required) - Why explicit edges
- [A3 Bindings](/concepts/design-decisions/bindings-a3) - Binding syntax design
- [Architecture Overview](/concepts/architecture/overview) - System design
