...
The `emitsStartComplete` flag tells the flow runtime to wrap execution with lifecycle events.
...
- [Claude Agent](/docs/reference/api/anthropic-agent) - Built-in LLM agent
