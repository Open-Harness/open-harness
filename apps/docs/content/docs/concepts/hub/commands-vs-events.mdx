...
```typescript
// Stop everything
hub.abort("User requested cancellation");
```
...
- [Workflow Events](/reference/events/workflow-events) - Event catalog
- [Session Events](/reference/events/session-events) - Interactive events
