...
- [Context Propagation](/docs/concepts/hub/context-propagation) - How context flows
- [Commands vs Events](/docs/concepts/hub/commands-vs-events) - Bidirectional design
