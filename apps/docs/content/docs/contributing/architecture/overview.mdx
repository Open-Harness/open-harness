...
│   ├── rtv-channel/      # Real-time voice channel
...
export function createAnthropicTextAgent(config): AgentDefinition {
  // Anthropic-specific agent factory
}
```
...
- [Packages](/contributing/architecture/packages) - Package structure
- [Protocol vs Engine](/contributing/architecture/protocol-vs-engine) - The split
