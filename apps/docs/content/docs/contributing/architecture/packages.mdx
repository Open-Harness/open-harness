...
**Exports**:
- `defineHarness`, `createHub`
- `executeFlow`, `parseFlowYaml`, `compileFlow`
- `NodeRegistry`, `resolveBindings`, `evaluateWhen`
- `createAnthropicTextAgent`

### @open-harness/rtv-channel

Real-time voice channel for audio I/O:

```
packages/rtv-channel/
├── src/
│   └── index.ts      # Voice channel definition
└── package.json
```

**Exports**:
- Voice channel definition
- Audio processing utilities

### @open-harness/config (Internal)
...
Not published - used for monorepo consistency.
...
See [Versioning](/contributing/releasing/versioning) for details.

## Next Steps

- [Protocol vs Engine](/contributing/architecture/protocol-vs-engine) - The split pattern
- [New Channel Guide](/contributing/extending/new-channel) - Build a channel
- [Directory Layout](/contributing/architecture/directory-layout) - Detailed structure
