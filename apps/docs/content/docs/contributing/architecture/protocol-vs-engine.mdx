...
| `protocol/harness.ts` → `HarnessFactory` | `engine/harness.ts` → `defineHarness` |
...
- [Reading Specs](/contributing/specifications/reading-specs) - Internal specifications
- [Directory Layout](/contributing/architecture/directory-layout) - Full structure
