...
See [Changelog](/contributing/releasing/changelog) for details.

## Next Steps

- [Changelog](/contributing/releasing/changelog) - Release notes
- [Development Workflow](/contributing/development/workflow) - Making changes
- [Publishing](/contributing/extending/new-channel) - Package publishing
