...
const harness = defineHarness({
  channels: [
    createWebSocketChannel({ port: 8080 })
  ],
  agents: [myAgent]
});
```
...
- [Channel Definition](/reference/types/channel-definition) - Type reference
- [Adapter Pattern](/concepts/channels/adapter-pattern) - Channel concepts
- [Bidirectional Channels](/concepts/channels/bidirectional) - Input/output
