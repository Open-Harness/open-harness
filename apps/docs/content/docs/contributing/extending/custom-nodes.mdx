...
This guide covers adding built-in node types that ship with the kernel. For user-defined nodes in application code, see the [guides section](/guides/flows/custom-node-types).
...
- [Node Registry](/reference/api/node-registry) - Registry API
- [Testing](/contributing/development/testing) - Test strategy
