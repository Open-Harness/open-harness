...
5. **Validation gate**: Dispatch validator to check generated tasks.md:

   ```
   Task: oharnes.tasks:validator
   Prompt: |
     FEATURE_DIR: {FEATURE_DIR}
     TASKS_FILE: {FEATURE_DIR}/tasks.md
     Validate tasks.md against spec requirements.
   ```
   ...
   - **If `recommendation: block`** (score < 50):
     ...
     - ERROR: "Task validation failed. Critical issues must be addressed."
