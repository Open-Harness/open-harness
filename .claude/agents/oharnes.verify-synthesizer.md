...
1. Component scores (task completion, path accuracy, spec compliance, gate status, acceptance)
...
**DO**:
- Read all five verification YAMLs
- Calculate scores mathematically based on provided formula
- Generate synthesis.yaml with complete data
